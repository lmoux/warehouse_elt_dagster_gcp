...
pjm_table_schemas = {
    ...
    "ftr_model_bus_changes": [
        ...
        bigqueryLib.SchemaField("from_substation", "STRING", mode="REQUIRED"),
        bigqueryLib.SchemaField("from_voltage", "STRING", mode="REQUIRED"),
        bigqueryLib.SchemaField("from_equipment", "STRING", mode="REQUIRED"),
        bigqueryLib.SchemaField("from_name", "STRING", mode="REQUIRED"),
        bigqueryLib.SchemaField("to_id", "INTEGER", mode="REQUIRED"),
        bigqueryLib.SchemaField("to_txt_zone", "STRING", mode="REQUIRED"),
        bigqueryLib.SchemaField("to_substation", "STRING", mode="REQUIRED"),
        bigqueryLib.SchemaField("to_voltage", "STRING", mode="REQUIRED"),
        bigqueryLib.SchemaField("to_equipment", "STRING", mode="REQUIRED"),
